...
class HyIdcSpider(CrawlSpider):
    name = 'HY_IDC'
    allowed_domains = ['www.idcun.com']
    start_urls = ['http://www.idcun.com/plus/list.php?tid=6&TotalResult=10232&PageNo=1']
    custom_settings = {
        # 并发请求
    ...
    rules = (
        Rule(LinkExtractor(restrict_css='.hlgd-content  a'), callback='parse_item', follow=True),
