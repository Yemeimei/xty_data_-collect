...
class AutoYjSpider(CrawlSpider):
    name = 'auto_YJ'
    allowed_domains = ['www.china-qiche.com']
    start_urls = ['http://www.china-qiche.com']
    custom_settings = {
        # 并发请求
    ...
    rules = (
        ...
        Rule(LinkExtractor(restrict_css=' table a'), callback='parse_item', follow=True),
    )
