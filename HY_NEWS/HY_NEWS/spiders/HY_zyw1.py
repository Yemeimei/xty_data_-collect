...
class HyZyw1Spider(CrawlSpider):
    name = 'HY_zyw1'
    allowed_domains = ['www.zyzhan.com']
    start_urls = ['http://www.zyzhan.com/news/t14/list_p2.html']
    custom_settings = {
        # 并发请求
    ...
    rules = (
        ...
        Rule(LinkExtractor(restrict_css='.newspages .lt'), follow=True),
    )
