...
class HyJswSpider(CrawlSpider):
    ...
    def start_requests(self):
        urls = 'http://www.asianmetal.cn/news/getMoreProNews.am?productTwoID=14&jspBarNewsType=allTrend'
        yield self.make_requests_from_url(urls)
        urls ='http://www.asianmetal.cn/news/getMoreProNews.am?productOneID=3&jspBarNewsType=allTrend'
        yield self.make_requests_from_url(urls)
        urls ='http://www.asianmetal.cn/news/getMoreProNews.am?productTwoID=4&jspBarNewsType=allTrend'
        yield self.make_requests_from_url(urls)
    rules = (
        Rule(LinkExtractor(restrict_css='.newsTitleB a'), callback='parse_item', follow=True),
    )
