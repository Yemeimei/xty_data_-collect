...
class HyC114Spider(CrawlSpider):
    name = 'HY_C114'
    allowed_domains = ['www.c114.com.cn']
    start_urls = ['http://www.c114.com.cn']
    custom_settings = {
        # 并发请求
    ...
    rules = (
        Rule(LinkExtractor(restrict_css='.d2 a'), callback='parse_item', follow=True),
    )
