...
class HyJsSpider(CrawlSpider):
    name = 'HY_JS'
    allowed_domains = ['www.cnfeol.com']
    start_urls = ['https://www.cnfeol.com/news/internal_summary/default_p1.aspx']
    custom_settings = {
        # 并发请求
    ...
    rules = (
        Rule(LinkExtractor(restrict_css='#contentlistcontainer  .listbig'), callback='parse_item', follow=True),
