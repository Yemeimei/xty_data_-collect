...
class HySpider(CrawlSpider):
    ...
    def start_requests(self):
        try:
            ...
            for x in range(1, 481):
                formData = {
                     'params': '%7B%22columnId%22:%22c42511ce3f868a515b49668dd250290c80d4dc8930c7e455d0e6e14b8033eae2%22,%22param%22:%22%257B%2522pageNo%2522:'+str(x)+',%2522pageSize%2522:25%257D%22%7D'
                }
    ...
    def parse_page(self, response):
        ...
        for url in selector.css('.list a::attr(href)').extract():
            ...
            formData = {
                'params': '%7b%22articleId%22%3a%22'+str(articleId)+'%22%2c%22columnId%22%3a%22c42511ce3f868a515b49668dd250290c80d4dc8930c7e455d0e6e14b8033eae2%22%7d'
            }
