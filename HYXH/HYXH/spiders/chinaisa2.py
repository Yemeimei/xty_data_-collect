...
class HySpider(CrawlSpider):
    ...
    def start_requests(self):
        try:
            ...
            for x in range(1, 2):
                formData = {
                     'params': '%7B%22columnId%22:%222e3c87064bdfc0e43d542d87fce8bcbc8fe0463d5a3da04d7e11b4c7d692194b%22,%22param%22:%22%257B%2522pageNo%2522:'+str(x)+',%2522pageSize%2522:25%257D%22%7D'
                }
    ...
    def parse_page(self, response):
        ...
        for url in selector.css('.list a::attr(href)').extract():
            ...
            formData = {
                'params': '%7b%22articleId%22%3a%22'+str(articleId)+'%22%2c%22columnId%22%3a%222e3c87064bdfc0e43d542d87fce8bcbc8fe0463d5a3da04d7e11b4c7d692194b%22%7d'
            }
