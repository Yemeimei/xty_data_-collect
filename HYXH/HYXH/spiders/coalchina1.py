...
class HySpider(CrawlSpider):
    ...
    start_urls = [
        f'http://www.coalchina.org.cn/index.php?m=content&c=index&a=lists&catid=12&page={x}'
    ...
    rules = (
        Rule(LinkExtractor(restrict_css='.list.lh24.f14 a'), callback='parse_items', follow=True),
    )
    ...
    def parse_items(self, response):
        ...
        item['source'] = '国家煤炭工业协会'
        item['website'] =  '国家煤炭工业协会'
        item['link'] = lyurl
