...
class Yb360Spider(CrawlSpider):
    name = 'YB_360'
    allowed_domains = ['yingxiao.360.cn']
    custom_settings = {
        # 并发请求
    ...
    start_urls = ['http://yingxiao.360.cn/report/?p=1']

    rules = (
        Rule(LinkExtractor(restrict_css='.common-list a'), callback='parse_item', follow=True),
