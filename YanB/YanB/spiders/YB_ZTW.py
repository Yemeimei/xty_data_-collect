...
class YbZtwSpider(CrawlSpider):
    ...
    start_urls = ['https://www.chinaventure.com.cn/report/list.html']

    rules = (
        Rule(LinkExtractor(restrict_css='.common_report_zone a'), callback='parse_item', follow=True),
