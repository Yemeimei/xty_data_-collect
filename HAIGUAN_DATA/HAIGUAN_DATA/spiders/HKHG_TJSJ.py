...
class HkhgTjsjSpider(scrapy.Spider):
    name = 'HKHG_TJSJ'
    # allowed_domains = ['http://haikou.customs.gov.cn/haikou_customs/605737/605743/605745/index.html']
    start_urls = ['http://haikou.customs.gov.cn/haikou_customs/605737/605743/605745/index.html']
    ...
    def parse_item(self, response):
        if response.status == 209:
            ...
            try:
                ...
                item['name'] = '中华人民共和国海口海关'
                item['website'] = '中华人民共和国海口海关-统计数据'
                item['link'] = response.url
                item['txt'] = ''.join(
                    response.css('#easysiteText *::text').extract())
                item['module_name'] = '中华人民共和国海口海关-统计数据'
                item['spider_name'] = 'HKHG_TJSJ'
                print(
                        "===========================>crawled one item" +
