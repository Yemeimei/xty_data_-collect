...
class LzhgTjsjSpider(scrapy.Spider):
    name = 'LZHG_TJSJ'
    # allowed_domains = ['http://lanzhou.customs.gov.cn/lanzhou_customs/553124/553126/553127/index.html']
    start_urls = ['http://lanzhou.customs.gov.cn/lanzhou_customs/553124/553126/553127/index.html']
    ...
    #     urls = 'http://39.96.199.128:8888/getCookie?url=http://lanzhou.customs.gov.cn/eportal/ui?pageId=434774&currentPage=1&moduleId=1667380986bc42c583c65be8d74da7d1&staticRequest=yes'
    ...
    def parse_item(self, response):
        if response.status == 209:
            ...
            try:
                ...
                item['website'] = '中华人民共和国兰州海关-统计数据'
                item['link'] = response.url
                item['txt'] = ''.join(
                    response.css('#easysiteText *::text').extract())
                item['module_name'] = '中华人民共和国兰州海关-统计数据'
                item['spider_name'] = 'LZHG_TJSJ'
                print(
                        "===========================>crawled one item" +
