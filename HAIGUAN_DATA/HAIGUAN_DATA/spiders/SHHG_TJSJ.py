...
class SzhgTjsjSpider(scrapy.Spider):
    ...
    #     urls = 'http://39.96.199.128:8888/getCookie?url=http://shanghai.customs.gov.cn/eportal/ui?pageId=434774&currentPage=1&moduleId=1667380986bc42c583c65be8d74da7d1&staticRequest=yes'
    #     yield scrapy.Request(urls, callback=self.parseCookie, meta={
    #         'url': 'http://shanghai.customs.gov.cn/eportal/ui?pageId=434774&currentPage=1&moduleId=1667380986bc42c583c65be8d74da7d1&staticRequest=yes',
    #         'type': 'parse'},
    ...
    def parse_total(self, response):
        if response.status == 209:
            ...
            for page_num in range(page_count):
                url = 'http://shanghai.customs.gov.cn/eportal/ui?pageId=' + page_id + '&currentPage=' + \
