...
class SyhgTjsjSpider(scrapy.Spider):
    name = 'SYHG_TJSJ'
    # allowed_domains = ['http://shenyang.customs.gov.cn/shenyang_customs/462357/462359/462360/index.html']
    start_urls = ['http://shenyang.customs.gov.cn/shenyang_customs/462357/462359/462360/index.html']
    ...
    #     urls = 'http://39.96.199.128:8888/getCookie?url=http://shenyang.customs.gov.cn/eportal/ui?pageId=434774&currentPage=1&moduleId=1667380986bc42c583c65be8d74da7d1&staticRequest=yes'
    #     yield scrapy.Request(urls, callback=self.parseCookie, meta={
    #         'url': 'http://shenyang.customs.gov.cn/eportal/ui?pageId=434774&currentPage=1&moduleId=1667380986bc42c583c65be8d74da7d1&staticRequest=yes',
    #         'type': 'parse'},
    ...
    def parse(self, response):
        if response.status == 209:
            ...
            url = 'http://shenyang.customs.gov.cn/eportal/ui?pageId=' + page_id + \
    ...
    def parse_total(self, response):
        if response.status == 209:
            ...
            for page_num in range(page_count):
                url = 'http://shenyang.customs.gov.cn/eportal/ui?pageId=' + page_id + '&currentPage=' + \
