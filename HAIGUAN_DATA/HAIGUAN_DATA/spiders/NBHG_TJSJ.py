...
class NbhgTjsjSpider(scrapy.Spider):
    name = 'NBHG_TJSJ'
    # allowed_domains = ['http://ningbo.customs.gov.cn/ningbo_customs/470752/470758/470759/gdzjckqkb/index.html']
    start_urls = ['http://ningbo.customs.gov.cn/ningbo_customs/470752/470758/470759/gdzjckqkb/index.html']
    ...
    #     urls = 'http://39.96.199.128:8888/getCookie?url=http://ningbo.customs.gov.cn/eportal/ui?pageId=434774&currentPage=1&moduleId=1667380986bc42c583c65be8d74da7d1&staticRequest=yes'
    ...
    def parse_item(self, response):
        if response.status == 209:
            ...
            try:
                ...
                item['website'] = '中华人民共和国宁波海关-统计数据'
                item['link'] = response.url
                item['txt'] = ''.join(
                    response.css('#easysiteText *::text').extract())
                item['module_name'] = '中华人民共和国宁波海关-统计数据'
                item['spider_name'] = 'NBHG_TJSJ'
                print(
                        "===========================>crawled one item" +
