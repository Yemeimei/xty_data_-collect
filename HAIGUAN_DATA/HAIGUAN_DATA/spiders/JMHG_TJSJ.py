...
class JmhgTjsjSpider(scrapy.Spider):
    name = 'JMHG_TJSJ'
    # allowed_domains = ['http://jiangmen.customs.gov.cn/jiangmen_customs/536578/536580/536581/index.html']
    start_urls = ['http://jiangmen.customs.gov.cn/jiangmen_customs/536578/536580/536581/index.html']
    ...
    #     urls = 'http://39.96.199.128:8888/getCookie?url=http://jiangmen.customs.gov.cn/eportal/ui?pageId=434774&currentPage=1&moduleId=1667380986bc42c583c65be8d74da7d1&staticRequest=yes'
    ...
    def parse_item(self, response):
        if response.status == 209:
            ...
            try:
                ...
                item['website'] = '中华人民共和国江门海关-统计数据'
                item['link'] = response.url
                item['txt'] = ''.join(
                    response.css('#easysiteText *::text').extract())
                item['module_name'] = '中华人民共和国江门海关-统计数据'
                item['spider_name'] = 'JMHG_TJSJ'
                print(
                        "===========================>crawled one item" +
