...
class QdhgTjsjSpider(scrapy.Spider):
    name = 'QDHG_TJSJ'
    # allowed_domains = ['http://qingdao.customs.gov.cn/qingdao_customs/406484/406514/406515/index.html']
    start_urls = ['http://qingdao.customs.gov.cn/qingdao_customs/406484/406514/406515/index.html']
    ...
    #     urls = 'http://39.96.199.128:8888/getCookie?url=http://qingdao.customs.gov.cn/eportal/ui?pageId=434774&currentPage=1&moduleId=1667380986bc42c583c65be8d74da7d1&staticRequest=yes'
    ...
    def parse_item(self, response):
        if response.status == 209:
            ...
            try:
                ...
                item['website'] = '中华人民共和国青岛海关-统计数据'
                item['link'] = response.url
                item['txt'] = ''.join(
                    response.css('#easysiteText *::text').extract())
                item['module_name'] = '中华人民共和国青岛海关-统计数据'
                item['spider_name'] = 'QDHG_TJSJ'
                print(
                        "===========================>crawled one item" +
