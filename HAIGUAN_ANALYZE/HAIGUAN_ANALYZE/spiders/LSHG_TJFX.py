...
class LshgTjfxSpider(scrapy.Spider):
    name = 'LSHG_TJFX'
    # allowed_domains = ['http://lasa.customs.gov.cn/lasa_customs/613421/613423/613425/index.html']
    start_urls = ['http://lasa.customs.gov.cn/lasa_customs/613421/613423/613425/index.html']
    ...
    #     urls = 'http://39.96.199.128:8888/getCookie?url=http://lasa.customs.gov.cn/eportal/ui?pageId=434775&currentPage=4&moduleId=6887eda10828436ea29ad29e60cb778a&staticRequest=yes'
    ...
    def parse_item(self, response):
        if response.status == 209:
            ...
            try:
                ...
                item['website'] = '中华人民共和国拉萨海关-统计分析'
                item['link'] = response.url
                item['txt'] = ''.join(
                    response.css('#easysiteText *::text').extract())
                item['module_name'] = '中华人民共和国拉萨海关-统计分析'
                item['spider_name'] = 'LSHG_TJFX'
                print(
                        "===========================>crawled one item" +
