...
class HfhgTjfxSpider(scrapy.Spider):
    name = 'HFHG_TJFX'
    # allowed_domains = ['http://hefei.customs.gov.cn/hefei_customs/479578/479584/479586/index.html']
    start_urls = ['http://hefei.customs.gov.cn/hefei_customs/479578/479584/479586/index.html']
    ...
    #     urls = 'http://39.96.199.128:8888/getCookie?url=http://hefei.customs.gov.cn/hefei_customs/479578/479584/479586/index.html'
    #     yield scrapy.Request(urls, callback=self.parseCookie, meta={
    #         'url': 'http://hefei.customs.gov.cn/hefei_customs/479578/479584/479586/index.html',
    #         'type': 'parse'},
    ...
    def parse_item(self, response):
        if response.status == 209:
            ...
            try:
                ...
                item['website'] = '中华人民共和国合肥海关-统计分析'
                item['link'] = response.url
                item['txt'] = ''.join(
                    response.css('#easysiteText *::text').extract())
                item['module_name'] = '中华人民共和国合肥海关-统计分析'
                item['spider_name'] = 'HFHG_TJFX'
                print(
                        "===========================>crawled one item" +
