...
class SthgTjfxSpider(scrapy.Spider):
    name = 'STHG_TJFX'
    # allowed_domains = ['http://shantou.customs.gov.cn/shantou_customs/596193/596220/596221/index.html']
    start_urls = ['http://shantou.customs.gov.cn/shantou_customs/596193/596220/596221/index.html']
    ...
    #     urls = 'http://39.96.199.128:8888/getCookie?url=http://shantou.customs.gov.cn/eportal/ui?pageId=434775&currentPage=4&moduleId=6887eda10828436ea29ad29e60cb778a&staticRequest=yes'
    ...
    def parse_item(self, response):
        if response.status == 209:
            ...
            try:
                ...
                item['website'] = '中华人民共和国汕头海关-统计分析'
                item['link'] = response.url
                item['txt'] = ''.join(
                    response.css('#easysiteText *::text').extract())
                item['module_name'] = '中华人民共和国汕头海关-统计分析'
                item['spider_name'] = 'STHG_TJFX'
                print(
                        "===========================>crawled one item" +
