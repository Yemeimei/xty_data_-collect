...
class XmhgTjfxSpider(scrapy.Spider):
    name = 'XMHG_TJFX'
    # allowed_domains = ['http://xiamen.customs.gov.cn/xiamen_customs/491078/491080/491082/index.html']
    start_urls = ['http://xiamen.customs.gov.cn/xiamen_customs/491078/491080/491082/index.html']
    ...
    #     urls = 'http://39.96.199.128:8888/getCookie?url=http://xiamen.customs.gov.cn/eportal/ui?pageId=434775&currentPage=4&moduleId=6887eda10828436ea29ad29e60cb778a&staticRequest=yes'
    #     yield scrapy.Request(urls, callback=self.parseCookie, meta={
    #         'url': 'http://xiamen.customs.gov.cn/eportal/ui?pageId=434774&currentPage=1&moduleId=1667380986bc42c583c65be8d74da7d1&staticRequest=yes',
    #         'type': 'parse'},
    ...
    def parse_item(self, response):
        if response.status == 209:
            ...
            try:
                ...
                item['name'] = '中华人民共和国厦门海关'
                item['website'] = '中华人民共和国厦门海关-统计分析'
                item['link'] = response.url
                item['txt'] = ''.join(
                    response.css('#easysiteText *::text').extract())
                item['module_name'] = '中华人民共和国厦门海关-统计分析'
                item['spider_name'] = 'XMHG_TJFX'
                print(
                        "===========================>crawled one item" +
