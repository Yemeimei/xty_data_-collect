...
class GzhgTjfxSpider(scrapy.Spider):
    name = 'GZHG_TJFX'
    # allowed_domains = ['http://guangzhou.customs.gov.cn/guangzhou_customs/381558/381572/381574/index.html']
    start_urls = ['http://guangzhou.customs.gov.cn/guangzhou_customs/381558/381572/381574/index.html']
    ...
    #     urls = 'http://39.96.199.128:8888/getCookie?url=http://guangzhou.customs.gov.cn/eportal/ui?pageId=434775&currentPage=4&moduleId=6887eda10828436ea29ad29e60cb778a&staticRequest=yes'
    #     yield scrapy.Request(urls, callback=self.parseCookie, meta={
    #         'url': 'http://guangzhou.customs.gov.cn/eportal/ui?pageId=434775&currentPage=4&moduleId=6887eda10828436ea29ad29e60cb778a&staticRequest=yes',
    #         'type': 'parse'},
    ...
    def parse_item(self, response):
        if response.status == 209:
            ...
            try:
                ...
                item['website'] = '中华人民共和国广州海关-统计分析'
                item['link'] = response.url
                item['txt'] = ''.join(
                    response.css('#easysiteText *::text').extract())
                item['module_name'] = '中华人民共和国广州海关-统计分析'
                item['spider_name'] = 'GZHG_TJFX'
                print(
                        "===========================>crawled one item" +
