...
class TjhgTjfxSpider(scrapy.Spider):
    name = 'TJHG_TJFX'
    # allowed_domains = ['http://tianjin.customs.gov.cn/tianjin_customs/427875/427909/427910/index.html']
    start_urls = [
        'http://tianjin.customs.gov.cn/tianjin_customs/427875/427909/427910/index.html']
    ...
    #     urls = 'http://39.96.199.128:8888/getCookie?url=http://tianjin.customs.gov.cn/eportal/ui?pageId=434775&currentPage=4&moduleId=6887eda10828436ea29ad29e60cb778a&staticRequest=yes'
    #     yield scrapy.Request(urls, callback=self.parseCookie, meta={
    #         'url': 'http://tianjin.customs.gov.cn/eportal/ui?pageId=434774&currentPage=1&moduleId=1667380986bc42c583c65be8d74da7d1&staticRequest=yes',
    #         'type': 'parse'},
